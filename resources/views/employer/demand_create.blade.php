...
<div id="page-wrapper">  
    <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Create Demand Letter</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
    <div class="row">
                            ...
                            <div class="panel-body">
                                <div class="dataTable_wrapper">
                                    <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                        ...
                                        <tr>
                                        <td>Title:</td><td> <input class="form-control" type="text" name="title" id="title" value="{{{isset($input['title'])?$input['title']:''}}}">@if ($errors->has('title')) <p class="help-block">{{ $errors->first('title') }}</p> @endif</td>
                                                                                    
                                        </tr>
                                        <tr>
                                        <td>No of Vacancies:</td><td><input class="form-control" type="text" name="no_vacancy" id="no_vacancy" value="{{{isset($input['no_vacancy'])?$input['no_vacancy']:''}}}">@if ($errors->has('no_vacancy')) <p class="help-block">{{ $errors->first('no_vacancy') }}</p> @endif</td>
                                        </tr>
                                        <tr>
                                        <td>Minimum Qualification:</td><td><input class="form-control" type="text" name="qualification" id="qualification" value="{{{isset($input['qualification'])?$input['qualification']:''}}}">@if ($errors->has('qualification')) <p class="help-block">{{ $errors->first('qualification') }}</p> @endif</td>
                                        </tr>
                                        <tr>
                                        <td>Location:</td><td><input class="form-control" type="text" name="location" id="location" value="{{{isset($input['location'])?$input['location']:''}}}">@if ($errors->has('location')) <p class="help-block">{{ $errors->first('location') }}</p> @endif</td>
                                        </tr>
                                        <tr>
                                        <td>Description:</td><td> <textarea class="form-control" id="description" name="description" index="1" rows="10">{{{isset($input['description'])?$input['description']:''}}}</textarea></td>
                                        </tr>
