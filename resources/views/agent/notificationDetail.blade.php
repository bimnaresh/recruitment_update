...
<div id="page-wrapper">  
    <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Email Details</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
    <div class="row">
                            ...
                            <div class="panel-body">
                                <div class="dataTable_wrapper">
                                    <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                        ...
                                        <tr>
                                        <td>Subject:</td><td>{{$notif->subject}}</td>
                                        </tr>
                                        <tr>
                                        <td>Message:</td><td>{{$notif->message}}</td>
                                        </tr>
                                       <tr>
                                        <td>Date:</td><td>{{date("Y-m-d",strtotime($notif->created_at))}}</td>
                                        </tr>
                                        <tr>
                                            <td>
