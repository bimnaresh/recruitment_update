...
<div id="page-wrapper">
    ...
    <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Demand List</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
    <div class="row">
...
//                                                                                    ->where('demandId',$deman->id)->first();
                                        ...
                                        <tr>
                                           <td> {!! Form::checkbox('demand[]',$deman->id)!!}</td>
                                            ...
                                            <td>
                                                <a href="{{url()}}/demand_view_detail/{{{$deman->id}}}"><button type="button" class="btn-xs btn-warning">View Details</button></a>
                                              
                                                <!--<a href="{{url()}}/demand_delete/{{{$deman->id}}}"><button type="button" class="btn-xs btn-danger">Delete</button></a>-->
