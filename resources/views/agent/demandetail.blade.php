...
<div id="page-wrapper">  
    <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Demand Details</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
    <div class="row">
                            ...
                            <div class="panel-body">
                                <div class="dataTable_wrapper">
                                    <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                        ...
                                        <td>Employer Name:</td><td>{{$emdet->name}}</td>
                                        </tr>
                                        <tr>                                     
                                        
                                        <tr>
                                        <td>Job Title:</td><td>{{$det->title}}</td>
                                        </tr>
                                        <tr>
                                        <td>Description:</td><td>{{$det->description}}</td>
                                        </tr>
                                        <tr>
                                        <td>Qualification:</td><td>{{$det->qualification}}</td>
                                        </tr>
                                        <tr>
                                        <td>Number Of Vacancies:</td><td>{{$det->no_vacancy}}</td>
                                        </tr>
                                        <tr>
                                        <td>Location:</td><td>{{$det->location}}</td>
                                        </tr>
                                        <tr>
                                        <td>Employer Address:</td><td>{{$emdet->address}}</td>
                                        </tr>
                                        <tr>
